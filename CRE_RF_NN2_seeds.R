...
for(p in file_contents) { 
  ...
  tryCatch({
    ...
    # cat("Dropout 1:", b_hyper_dropouts, "\n")
    # cat("Dropout 2:", b_hyper_dropouts2, "\n")
    # cat("Seed:", best_seed, "\n")
    ...
    saveRDS(acc_nested_list, "/projects/apog/work/models/1MB/new_MLP_seed/NN2/NN2_statistics_30.RDS") #local
